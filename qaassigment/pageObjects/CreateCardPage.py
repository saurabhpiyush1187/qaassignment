...
class CreateCard:
    ...
    def clickCard(self, pstr_type):
        try:
            ...
            self.driver.save_screenshot("." + os.sep + "Screenshots" + os.sep + "test_login_createCard_exception.png")
            self.driver.close()
            assert False
    ...
    def verify_modal_header(self, pstr_header):
        try:
            ...
            self.logger.info(exception_msg)
            self.driver.save_screenshot("." + os.sep + "Screenshots" + os.sep + "test_login_modal_header_fail.png")
            self.driver.close()
            return False
    ...
    def create_card(self,pstr_title, pstr_description):
        try:
            ...
            self.logger.info(exception_msg)
            self.driver.save_screenshot("." + os.sep + "Screenshots" + os.sep + "test_login_create_card_fail.png")
            self.driver.close()
            assert False
    ...
    def verify_card(self,pstr_card_type,pstr_title,pstr_desciption):
        try:
            ...
            self.logger.info(exception_msg)
            self.driver.save_screenshot("." + os.sep + "Screenshots" + os.sep + "test_login_createcard_details_verify_fail_exception.png")
            self.driver.close()
            return False
    ...
    def verify_activity(self,pstr_card,pstr_activity,**kwargs):
        try:
            ...
            self.logger.info(exception_msg)
            self.driver.save_screenshot("." + os.sep + "Screenshots" + os.sep + "test_login_createcard_like_activity_verify_fail.png")
            self.driver.close()
            return False
